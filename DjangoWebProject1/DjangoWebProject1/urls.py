...
urlpatterns = patterns('',
    ...
    url(r'^filterlanguages', 'app.views.language_filter', name='filterLanguages'),
    ...
    url(r'^addlanguage', 'app.views.add_language', name='addLanguage'),
    ...
    url(r'^removelanguage', 'app.views.remove_language', name='removeLanguage'),
